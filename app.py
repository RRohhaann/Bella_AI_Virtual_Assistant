...
site_urls = {
    ...
    "Deenbandhu Chhotu Ram University of Science & Technology": "https://www.dcrustm.ac.in/",
...
def execute_command():
    ...
    # Ask with AI (ChatGPT)
    elif "ask with ai" in text or "bella" in text:
    ...
    # Search on YouTube
        ...
        ai_response = "I was created by Rohan"

    elif "what is your name" in text:
        ai_response = "my name is Bella."

    elif "tell me about yourself" in text:
        ai_response = "Hello! I am Bella AI, a highly intelligent virtual assistant designed to efficiently perform various tasks and provide seamless assistance. How may I help you?"
        ...
        ai_response = "I’m your personal AI assistant created by Rohan!"
